...
class RocketchatListener < Redmine::Hook::Listener
	def controller_issues_new_after_save(context={})
		...
		msg = "[#{project_url}] *#{escape issue.author}* created new issue <#{object_url issue}|#{escape issue}>#{mentions issue.description}"
	...
	def controller_issues_edit_after_save(context={})
		...
		msg = "[#{project_url}] *#{escape journal.user.to_s}* updated issue <#{object_url issue}|#{escape issue}>#{mentions journal.notes}"
	...
	def model_changeset_scan_commit_for_issue_ids_pre_issue_update(context={})
		...
		msg = "[#{project_url}] *#{escape journal.user.to_s}* updated <#{object_url issue}|#{escape issue}>"
	...
	def controller_wiki_edit_after_save(context = { })
		...
		comment = "[#{project_url}] *#{user}* updated wiki page #{page_url}"
